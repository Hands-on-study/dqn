...
class DQNAgent:
    def __init__(self, state_size, action_size):
        ...
        # 리플레이 메모리, 오래된 데이터를 자동으로 삭제하는 deque 자료구조 사용
    ...
    # 타겟 모델의 가중치를 메인 모델의 가중치로 복사하는 함수
    ...
    def get_action(self, state):
        ...
        return np.argmax(q_value[0])  # 가장 높은 Q값을 갖는 액션 선택
    ...
    def train_model(self):
        ...
        target_val = self.traget_model.predict(next_states, verbose=0)
